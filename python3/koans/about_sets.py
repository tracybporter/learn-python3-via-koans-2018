...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        setsOmitDuplicates = set(highlanders)

        self.assertEqual(4, setsOmitDuplicates.__len__())

    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        self.assertEqual(set, {1, 2, 3}.__class__)  # not be be confused with the dictionary use of {}
    ...
    def test_convert_the_set_into_a_list_to_sort_it(self):
        # sorted takes an interable - it is not obvious to me how the following statement
        # converted the set to a list as stated in the method name
        self.assertEqual(['1', '2', '3', '4', '5'], sorted(set('54321')))

    # ------------------------------------------------------------------

    def test_set_have_arithmetic_operators(self):
        # does this suggest that other iterables do not have similar capabilities?
