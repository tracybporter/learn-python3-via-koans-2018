...
class AboutMethods(Koan):
    ...
    def pointless_method_with_return(self, a, b):
        return a + b

    def test_which_does_not_return_anything(self):
        self.assertEqual(None, self.pointless_method(1, 2))
        self.assertEqual(3, self.pointless_method_with_return(1, 2))
    ...
    def method_with_documentation(self):
        "Comments should almost NEVER be used. Write self documenting code instead."
        return "ok"

    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        self.assertRegex(self.method_with_documentation.__doc__, "Comments should almost NEVER be used. Write self documenting code instead.")
    ...
    class Dog:
        ...
        def __password(self): # NOTE: Two underscores
