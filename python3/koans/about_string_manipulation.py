...
class AboutStringManipulation(Koan):
    ...
    def test_formatted_values_can_be_shown_in_any_order_or_be_repeated(self):
        value1 = 'zero'
        value2 = 'DOH'
        singleString = 'The values are {1}, {0}, {0} and {1}!'.format(value1, value2)
        doubleString = "The values are {1}, {0}, {0} and {1}!".format(value1, value2)

        self.assertEqual('The values are DOH, zero, zero and DOH!', singleString)
        self.assertEqual('The values are DOH, zero, zero and DOH!', doubleString)
    ...
    def test_single_characters_can_be_represented_by_integers(self):
        a_as_ascii = 97
        self.assertEqual(a_as_ascii, ord('a'))
